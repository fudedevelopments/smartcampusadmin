...
class BannerImages extends amplify_core.Model {
  ...
  const BannerImages._internal({required this.id, bannerimage, createdAt, updatedAt}): _bannerimage = bannerimage, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory BannerImages({String? id, List<String>? bannerimage}) {
    return BannerImages._internal(
      id: id == null ? amplify_core.UUID.getUUID() : id,
      bannerimage: bannerimage != null ? List<String>.unmodifiable(bannerimage) : bannerimage);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is BannerImages &&
      id == other.id &&
      DeepCollectionEquality().equals(_bannerimage, other._bannerimage);
  }
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("bannerimage=" + (_bannerimage != null ? _bannerimage!.toString() : "null") + ", ");
  ...
  BannerImages copyWith({List<String>? bannerimage}) {
    return BannerImages._internal(
      id: id,
  ...
  BannerImages copyWithModelFieldValues({
    ModelFieldValue<List<String>?>? bannerimage
  }) {
    return BannerImages._internal(
      id: id,
      bannerimage: bannerimage == null ? this.bannerimage : bannerimage.value
    );
  }
  
  BannerImages.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _bannerimage = json['bannerimage']?.cast<String>(),
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'bannerimage': _bannerimage, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final BANNERIMAGE = amplify_core.QueryField(fieldName: "bannerimage");
